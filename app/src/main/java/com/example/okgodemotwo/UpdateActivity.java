...
//        mEquipmentDatasBean.setIsOn("0");
        mEquipmentDatasBean.setEquipmentModelState("2"); //2关 1开
//        mEquipmentDatasBean.setEquipmentState(1);
...
//        mEquipmentDatasBean.setProductVersion("");
        ...
        /**
         ...
         equipmentModelIcon: String,
         equipmentModelRepeat: String,

         equipmentList: String,
         stateList: String,
         equipmentModelBeginTime: String,
         equipmentModelEndTime: String,

         beginIf: String,
         endIf: String,
         onOff: String
         现在修改差不多可以了    接下来  就是处理json  然后执行结果 顶唔住
         */
...
//        mUpdateModelSendBean.setEquipmentDatas(list);
        mUpdateModelSendBean.setEquipmentModelEndTime("00:13");
